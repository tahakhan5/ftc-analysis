...
csv_file = open(os.path.join(OUT_PATH, '7_fraud_ages.csv'), "w")
...
cursor.execute(
		'''
			SELECT CP.CustomerZip, CP.Crimes, CP.Population, ages.Age FROM
			...
			INNER JOIN ages ON ages.ZipCode == CP.CustomerZip
	    ''')
